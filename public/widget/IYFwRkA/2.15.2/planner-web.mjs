...
var B = { MODULE_VERSION: "2.15.2", COMPRESSED_ORG: "IYFwRkA", ORG_ID: "atb" };
...
function Be(t, e, i) {
  const o = t.action, a = O(new FormData(t), "pw-assistant"), s = Re({ from: e, to: i }, a), d = new URLSearchParams(s);
  window.location.href = `${o}?${d.toString()}`;
}
function Oe(t, e) {
  const i = t.action, o = O(new FormData(t), "pw-departures"), a = Ge(o, e), s = new URLSearchParams(a);
