...
var C = { MODULE_VERSION: "2.0.0", COMPRESSED_ORG: "HYMw1kA" };
...
function De(e, t, n) {
  const s = e.action, i = M(new FormData(e)), l = Ne({ from: t, to: n }, i), a = new URLSearchParams(l);
  window.location.href = `${s}?${a.toString()}`;
}
function Oe(e, t) {
  const n = e.action, s = M(new FormData(e)), i = Ge(t, s), l = new URLSearchParams(i);
