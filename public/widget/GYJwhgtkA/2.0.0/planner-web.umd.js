(function(b,$){typeof exports=="object"&&typeof module<"u"?$(exports):typeof define=="function"&&define.amd?define(["exports"],$):(b=typeof globalThis<"u"?globalThis:b||self,$(b.PlannerWeb={}))})(this,function(b){"use strict";class ${constructor(t,n,{tabInsertsSuggestions:i,defaultFirstOption:s,scrollIntoViewOptions:l}={}){this.input=t,this.list=n,this.tabInsertsSuggestions=i??!0,this.defaultFirstOption=s??!1,this.scrollIntoViewOptions=l,this.isComposing=!1,n.id||(n.id=`combobox-${Math.random().toString().slice(2,6)}`),this.ctrlBindings=!!navigator.userAgent.match(/Macintosh/),this.keyboardEventHandler=a=>j(a,this),this.compositionEventHandler=a=>W(a,this),this.inputHandler=this.clearSelection.bind(this),t.setAttribute("role","combobox"),t.setAttribute("aria-controls",n.id),t.setAttribute("aria-expanded","false"),t.setAttribute("aria-autocomplete","list"),t.setAttribute("aria-haspopup","listbox")}destroy(){this.clearSelection(),this.stop(),this.input.removeAttribute("role"),this.input.removeAttribute("aria-controls"),this.input.removeAttribute("aria-expanded"),this.input.removeAttribute("aria-autocomplete"),this.input.removeAttribute("aria-haspopup")}start(){this.input.setAttribute("aria-expanded","true"),this.input.addEventListener("compositionstart",this.compositionEventHandler),this.input.addEventListener("compositionend",this.compositionEventHandler),this.input.addEventListener("input",this.inputHandler),this.input.addEventListener("keydown",this.keyboardEventHandler),this.list.addEventListener("click",x),this.indicateDefaultOption()}stop(){this.clearSelection(),this.input.setAttribute("aria-expanded","false"),this.input.removeEventListener("compositionstart",this.compositionEventHandler),this.input.removeEventListener("compositionend",this.compositionEventHandler),this.input.removeEventListener("input",this.inputHandler),this.input.removeEventListener("keydown",this.keyboardEventHandler),this.list.removeEventListener("click",x)}indicateDefaultOption(){var t;this.defaultFirstOption&&((t=Array.from(this.list.querySelectorAll('[role="option"]:not([aria-disabled="true"])')).filter(T)[0])===null||t===void 0||t.setAttribute("data-combobox-option-default","true"))}navigate(t=1){const n=Array.from(this.list.querySelectorAll('[aria-selected="true"]')).filter(T)[0],i=Array.from(this.list.querySelectorAll('[role="option"]')).filter(T),s=i.indexOf(n);if(s===i.length-1&&t===1||s===0&&t===-1){this.clearSelection(),this.input.focus();return}let l=t===1?0:i.length-1;if(n&&s>=0){const c=s+t;c>=0&&c<i.length&&(l=c)}const a=i[l];if(a)for(const c of i)c.removeAttribute("data-combobox-option-default"),a===c?(this.input.setAttribute("aria-activedescendant",a.id),a.setAttribute("aria-selected","true"),B(a),a.scrollIntoView(this.scrollIntoViewOptions)):c.removeAttribute("aria-selected")}clearSelection(){this.input.removeAttribute("aria-activedescendant");for(const t of this.list.querySelectorAll('[aria-selected="true"]'))t.removeAttribute("aria-selected");this.indicateDefaultOption()}}function j(e,t){if(!(e.shiftKey||e.metaKey||e.altKey)&&!(!t.ctrlBindings&&e.ctrlKey)&&!t.isComposing)switch(e.key){case"Enter":C(t.input,t.list)&&e.preventDefault();break;case"Tab":t.tabInsertsSuggestions&&C(t.input,t.list)&&e.preventDefault();break;case"Escape":t.clearSelection();break;case"ArrowDown":t.navigate(1),e.preventDefault();break;case"ArrowUp":t.navigate(-1),e.preventDefault();break;case"n":t.ctrlBindings&&e.ctrlKey&&(t.navigate(1),e.preventDefault());break;case"p":t.ctrlBindings&&e.ctrlKey&&(t.navigate(-1),e.preventDefault());break;default:if(e.ctrlKey)break;t.clearSelection()}}function x(e){if(!(e.target instanceof Element))return;const t=e.target.closest('[role="option"]');t&&t.getAttribute("aria-disabled")!=="true"&&q(t,{event:e})}function C(e,t){const n=t.querySelector('[aria-selected="true"], [data-combobox-option-default="true"]');return n?(n.getAttribute("aria-disabled")==="true"||n.click(),!0):!1}function q(e,t){e.dispatchEvent(new CustomEvent("combobox-commit",{bubbles:!0,detail:t}))}function B(e){e.dispatchEvent(new Event("combobox-select",{bubbles:!0}))}function T(e){return!e.hidden&&!(e instanceof HTMLInputElement&&e.type==="hidden")&&(e.offsetWidth>0||e.offsetHeight>0)}function W(e,t){t.isComposing=e.type==="compositionstart",document.getElementById(t.input.getAttribute("aria-controls")||"")&&t.clearSelection()}const o={"override-light":"theme-module__override-light",light:"theme-module__light",assistant:'"../page-modules/assistant/assistant.module.css"',departures:'"../page-modules/departures/departures.module.css"',search:'"../components/search/search.module.css"',selector:'"../modules/search-time/selector/selector.module.css"',buttonComponent:'"../components/button/button.module.css"',hidden:"widget-module__hidden",lightWrapper:"widget-module__lightWrapper theme-module__light",wrapper:"widget-module__wrapper theme-module__override-light",form:"widget-module__form assistant-module__container",nav:"widget-module__nav",tabs:"widget-module__tabs",tabSelected:"widget-module__tabSelected",main:"widget-module__main assistant-module__main",heading:"widget-module__heading assistant-module__heading",inputBoxes:"widget-module__inputBoxes",search_container:"widget-module__search_container search-module__container",search_inputContainer:"widget-module__search_inputContainer search-module__inputContainer",search_label:"widget-module__search_label search-module__label typography-module__typo-body__secondary",search_input:"widget-module__search_input search-module__input",search_inputLast:"widget-module__search_inputLast",button_geolocation:"widget-module__button_geolocation departures-module__geolocationButton",selector_group:"widget-module__selector_group selector-module__departureDateSelector",selector_options:"widget-module__selector_options selector-module__options",selector_options__small:"widget-module__selector_options__small selector-module__options",selector_option:"widget-module__selector_option selector-module__option selector-module__option",selector_option__text:"widget-module__selector_option__text selector-module__option__text",selector_option__label:"widget-module__selector_option__label selector-module__option__label",selector_option__input:"widget-module__selector_option__input selector-module__option__input",selector_dateAndTimeSelectorsWrapper:"widget-module__selector_dateAndTimeSelectorsWrapper selector-module__dateAndTimeSelectorsWrapper",selector_dateAndTimeSelectorsWrapper__hidden:"widget-module__selector_dateAndTimeSelectorsWrapper__hidden",selector_dateAndTimeSelectors:"widget-module__selector_dateAndTimeSelectors selector-module__dateAndTimeSelectors",selector_dateSelector:"widget-module__selector_dateSelector selector-module__dateSelector",selector_timeSelector:"widget-module__selector_timeSelector selector-module__timeSelector",buttonGroup:"widget-module__buttonGroup",button:"widget-module__button","button--disabled":"widget-module__button--disabled",listItem:"widget-module__listItem",itemIcon:"widget-module__itemIcon",itemLocality:"widget-module__itemLocality search-module__itemLocality typography-module__typo-body__secondary",popupContainer:"widget-module__popupContainer search-module__menu",messageBox:"widget-module__messageBox"};var I={MODULE_VERSION:"2.0.0",COMPRESSED_ORG:"GYJwhgtkA"};const F=300,w=String.raw,A=I.MODULE_VERSION,L=I.COMPRESSED_ORG;function N(e){if(!(e!=null&&e.startsWith("http")))throw new Error("Missing urlBase in correct schema.");return e.endsWith("/")||(e+="/"),{URL_BASE:e,URL_JS_UMD:`${e}widget/${L}/${A}/planner-web.umd.js`,URL_JS_ESM:`${e}widget/${L}/${A}/planner-web.mjs`,URL_CSS:`${e}widget/${L}/${A}/planner-web.css`}}function G({urlBase:e}){const t=N(e);return{output:K(t),init:R,urls:t}}function R(){var t,n;Q(),M("pw-assistant"),M("pw-departure");let e={from:void 0,to:void 0};document.addEventListener("search-selected",function(i){const s=i;e[s.detail.key]=s.detail.item}),document.querySelectorAll("[name=searchTimeSelector]").forEach(function(i){i.addEventListener("change",function(s){const a=s.currentTarget.value==="now";document.querySelectorAll(".js-search-date-details").forEach(c=>{c.hidden=a})})}),(t=document.querySelector("#pw-form-departures"))==null||t.addEventListener("submit",i=>{i.preventDefault();const s=i.currentTarget;V(s,e.from)}),(n=document.querySelector("#pw-form-assistant"))==null||n.addEventListener("submit",i=>{i.preventDefault();const s=i.currentTarget;U(s,e.from,e.to)})}function M(e){const t=document.querySelector(`#${e}-searchTimeSelector-date`),n=document.querySelector(`#${e}-searchTimeSelector-time`);try{if(t&&(t.valueAsDate=new Date),n){const i=new Date;i.setSeconds(0),i.setMilliseconds(0),n.valueAsDate=i}}catch{}}function D(e){const t=e.get("searchTimeSelector");if(t==="now")return{mode:"now"};{const n=e.get("dateinput"),i=e.get("timeinput");if(n&&i){const s=new Date(`${n}T${i}`);return{mode:t=="arriveBy"?"arriveBy":"departBy",dateTime:s.getTime()}}return{mode:"now"}}}function U(e,t,n){const i=e.action,s=D(new FormData(e)),l=ee({from:t,to:n},s),a=new URLSearchParams(l);window.location.href=`${i}?${a.toString()}`}function V(e,t){const n=e.action,i=D(new FormData(e)),s=te(t,i),l=new URLSearchParams(s);window.location.href=`${n}?${l.toString()}`}class E extends HTMLElement{constructor(){super()}connectedCallback(){const t=this;t.hidden=!0,t.classList.add(o.messageBox),document.addEventListener("pw-errorMessage",function(n){const i=n;t.textContent=i.detail.message,t.hidden=!1}),document.addEventListener("pw-errorMessage-clear",function(n){t.hidden=!0}),t.addEventListener("click",function(){E.clearMessageBox()})}static clearMessageBox(){document.dispatchEvent(new CustomEvent("pw-errorMessage-clear",{bubbles:!0}))}}function K({URL_BASE:e}){function t(d){const r=i(d),p=g("span",[d.name]),m=g("span",[d.locality??""],o.itemLocality),_=g("li",[r,p,m],o.listItem);return _.role="option",_.setAttribute("data-feature-id",d.id),_}function n(d){const r=g("span",[d]);return g("li",[r],o.listItem)}function i(d){const r=Y(d.category),p=g("img");p.src=`${e}assets/mono/light/${r.icon}.svg`,p.alt=r.alt,p.role="img";const m=g("div",[p],o.itemIcon);return m.ariaHidden="true",m}class s extends HTMLElement{constructor(){super()}connectedCallback(){const r=this,p=r.getAttribute("data-mode")??"assistant";this.querySelector("button").addEventListener("click",async _=>{var f;E.clearMessageBox();try{const h=await ne(),y=(f=r.parentElement)==null?void 0:f.querySelector("input");y&&(y.value=h?`${h.name}, ${h.locality}`:y.value),document.dispatchEvent(new CustomEvent("search-selected",{bubbles:!0,detail:{mode:p,key:"from",item:h}}))}catch(h){h instanceof Error&&document.dispatchEvent(new CustomEvent("pw-errorMessage",{bubbles:!0,detail:{message:h.message}}))}})}}customElements.define("pw-geobutton",s),customElements.define("pw-messagebox",E);class l extends HTMLElement{constructor(){super(),this.dataList={}}getItem(r){return this.dataList[r]}setItems(r){this.dataList={};for(let p of r)this.dataList[p.id]=p}connectedCallback(){const r=this,p=J(this.getAttribute("data-debounce-ms"),F),m=this.querySelector("input"),_=this.querySelector("#"+this.getAttribute("for"));let f=new $(m,_,{scrollIntoViewOptions:!1});function h(u){u?f.start():(f.clearSelection(),f.stop()),_.hidden=!u}function y(){r.setItems([]),_.innerHTML="";const u=n("Ingen resultater");_.appendChild(u),h(!0)}const re=O(async u=>{try{if(!u.value){_.innerHTML="";return}const v=await oe(u.value);if(v.length===0)return y();r.setItems(v),_.innerHTML="";for(let S of v){const le=t(S);_.appendChild(le)}h(!0)}catch{y()}},p);m.addEventListener("keydown",u=>{u.key==="Escape"&&h(!1)}),m.addEventListener("input",u=>re(u.target)),m.addEventListener("focus",()=>h(!0)),m.addEventListener("blur",O(()=>h(!1),100)),document.addEventListener("click",u=>{P(u.target,this)||h(!1)}),_.addEventListener("combobox-commit",function(u){const v=u.target.getAttribute("data-feature-id"),S=v?r.getItem(v):void 0;m.value=S?`${S.name}, ${S.locality}`:m.value,document.dispatchEvent(new CustomEvent("search-selected",{bubbles:!0,detail:{mode:"assistant",key:m.name,item:S}})),_.hidden=!0,f.clearSelection(),f.stop()})}}customElements.define("pw-autocomplete",l);const a=w`
