  ...
  `,de=w`
    ...
    >
      <div class="${n.main}">
        ...
        ${o.layoutMode!=="compact"?F("pw-assistant"):""}
      </div>
      ${P}
    </form>
  `,pe=w`
    ...
    >
      <div class="${n.main}">
        ...
        ${o.layoutMode!=="compact"?F("pw-departures",!1):""}
      </div>
      ${P}
    </form>
  `;return w`
    <div
      ...
      class="${W({[n.wrapper]:!0,[n.inheritFont]:o.inheritFont??!1})}"
    >
      <nav class="${n.nav}">
