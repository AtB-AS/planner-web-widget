class H {
  constructor(e, n, { tabInsertsSuggestions: i, defaultFirstOption: r, scrollIntoViewOptions: s } = {}) {
    this.input = e, this.list = n, this.tabInsertsSuggestions = i ?? !0, this.defaultFirstOption = r ?? !1, this.scrollIntoViewOptions = s ?? { block: "nearest", inline: "nearest" }, this.isComposing = !1, n.id || (n.id = `combobox-${Math.random().toString().slice(2, 6)}`), this.ctrlBindings = !!navigator.userAgent.match(/Macintosh/), this.keyboardEventHandler = (c) => W(c, this), this.compositionEventHandler = (c) => x(c, this), this.inputHandler = this.clearSelection.bind(this), e.setAttribute("role", "combobox"), e.setAttribute("aria-controls", n.id), e.setAttribute("aria-expanded", "false"), e.setAttribute("aria-autocomplete", "list"), e.setAttribute("aria-haspopup", "listbox");
  }
  destroy() {
...
var O = { MODULE_VERSION: "2.20.1", COMPRESSED_ORG: "C4Jw9gtgzkA", ORG_ID: "troms" };
