(function(f,S){typeof exports=="object"&&typeof module<"u"?S(exports):typeof define=="function"&&define.amd?define(["exports"],S):(f=typeof globalThis<"u"?globalThis:f||self,S(f.PlannerWeb={}))})(this,function(f){"use strict";class S{constructor(e,i,{tabInsertsSuggestions:n,defaultFirstOption:r,scrollIntoViewOptions:s}={}){this.input=e,this.list=i,this.tabInsertsSuggestions=n??!0,this.defaultFirstOption=r??!1,this.scrollIntoViewOptions=s??{block:"nearest",inline:"nearest"},this.isComposing=!1,i.id||(i.id=`combobox-${Math.random().toString().slice(2,6)}`),this.ctrlBindings=!!navigator.userAgent.match(/Macintosh/),this.keyboardEventHandler=u=>H(u,this),this.compositionEventHandler=u=>x(u,this),this.inputHandler=this.clearSelection.bind(this),e.setAttribute("role","combobox"),e.setAttribute("aria-controls",i.id),e.setAttribute("aria-expanded","false"),e.setAttribute("aria-autocomplete","list"),e.setAttribute("aria-haspopup","listbox")}destroy(){this.clearSelection(),this.stop(),this.input.removeAttribute("role"),this.input.removeAttribute("aria-controls"),this.input.removeAttribute("aria-expanded"),this.input.removeAttribute("aria-autocomplete"),this.input.removeAttribute("aria-haspopup")}start(){this.input.setAttribute("aria-expanded","true"),this.input.addEventListener("compositionstart",this.compositionEventHandler),this.input.addEventListener("compositionend",this.compositionEventHandler),this.input.addEventListener("input",this.inputHandler),this.input.addEventListener("keydown",this.keyboardEventHandler),this.list.addEventListener("mousedown",C),this.indicateDefaultOption()}stop(){this.clearSelection(),this.input.setAttribute("aria-expanded","false"),this.input.removeEventListener("compositionstart",this.compositionEventHandler),this.input.removeEventListener("compositionend",this.compositionEventHandler),this.input.removeEventListener("input",this.inputHandler),this.input.removeEventListener("keydown",this.keyboardEventHandler),this.list.removeEventListener("mousedown",C)}indicateDefaultOption(){var e;this.defaultFirstOption&&((e=Array.from(this.list.querySelectorAll('[role="option"]:not([aria-disabled="true"])')).filter(A)[0])===null||e===void 0||e.setAttribute("data-combobox-option-default","true"))}navigate(e=1){const i=Array.from(this.list.querySelectorAll('[aria-selected="true"]')).filter(A)[0],n=Array.from(this.list.querySelectorAll('[role="option"]')).filter(A),r=n.indexOf(i);if(r===n.length-1&&e===1||r===0&&e===-1){this.clearSelection(),this.input.focus();return}let s=e===1?0:n.length-1;if(i&&r>=0){const p=r+e;p>=0&&p<n.length&&(s=p)}const u=n[s];if(u)for(const p of n)p.removeAttribute("data-combobox-option-default"),u===p?(this.input.setAttribute("aria-activedescendant",u.id),u.setAttribute("aria-selected","true"),F(u),u.scrollIntoView(this.scrollIntoViewOptions)):p.removeAttribute("aria-selected")}clearSelection(){this.input.removeAttribute("aria-activedescendant");for(const e of this.list.querySelectorAll('[aria-selected="true"]'))e.removeAttribute("aria-selected");this.indicateDefaultOption()}}function H(t,e){if(!(t.shiftKey||t.metaKey||t.altKey)&&!(!e.ctrlBindings&&t.ctrlKey)&&!e.isComposing)switch(t.key){case"Enter":D(e.input,e.list)&&t.preventDefault();break;case"Tab":e.tabInsertsSuggestions&&D(e.input,e.list)&&t.preventDefault();break;case"Escape":e.clearSelection();break;case"ArrowDown":e.navigate(1),t.preventDefault();break;case"ArrowUp":e.navigate(-1),t.preventDefault();break;case"n":e.ctrlBindings&&t.ctrlKey&&(e.navigate(1),t.preventDefault());break;case"p":e.ctrlBindings&&t.ctrlKey&&(e.navigate(-1),t.preventDefault());break;default:if(t.ctrlKey)break;e.clearSelection()}}function C(t){if(!(t.target instanceof Element))return;const e=t.target.closest('[role="option"]');e&&e.getAttribute("aria-disabled")!=="true"&&M(e,{event:t})}function D(t,e){const i=e.querySelector('[aria-selected="true"], [data-combobox-option-default="true"]');return i?(i.getAttribute("aria-disabled")==="true"||M(i),!0):!1}function M(t,e){t.dispatchEvent(new CustomEvent("combobox-commit",{bubbles:!0,detail:e}))}function F(t){t.dispatchEvent(new Event("combobox-select",{bubbles:!0}))}function A(t){return!t.hidden&&!(t instanceof HTMLInputElement&&t.type==="hidden")&&(t.offsetWidth>0||t.offsetHeight>0)}function x(t,e){e.isComposing=t.type==="compositionstart",document.getElementById(e.input.getAttribute("aria-controls")||"")&&e.clearSelection()}const o={"override-light":"theme-module__override-light",light:"theme-module__light",assistant:'"../page-modules/assistant/assistant.module.css"',departures:'"../page-modules/departures/departures.module.css"',search:'"../components/search/search.module.css"',selector:'"../modules/search-time/selector/selector.module.css"',buttonComponent:'"../components/button/button.module.css"',hidden:"widget-module__hidden",lightWrapper:"widget-module__lightWrapper theme-module__light",wrapper:"widget-module__wrapper theme-module__override-light",form:"widget-module__form assistant-module__container",nav:"widget-module__nav",tabs:"widget-module__tabs",tabSelected:"widget-module__tabSelected",main:"widget-module__main assistant-module__main",heading:"widget-module__heading assistant-module__heading",inputBoxes:"widget-module__inputBoxes",search_container:"widget-module__search_container search-module__container",search_inputContainer:"widget-module__search_inputContainer search-module__inputContainer",search_label:"widget-module__search_label search-module__label typography-module__typo-body__secondary",search_input:"widget-module__search_input search-module__input",search_inputLast:"widget-module__search_inputLast",button_geolocation:"widget-module__button_geolocation departures-module__geolocationButton",selector_group:"widget-module__selector_group selector-module__departureDateSelector",selector_options:"widget-module__selector_options selector-module__options",selector_options__small:"widget-module__selector_options__small selector-module__options",selector_option:"widget-module__selector_option selector-module__option",selector_option__text:"widget-module__selector_option__text selector-module__option__text",selector_option__label:"widget-module__selector_option__label selector-module__option__label",selector_option__input:"widget-module__selector_option__input selector-module__option__input",selector_dateAndTimeSelectorsWrapper:"widget-module__selector_dateAndTimeSelectorsWrapper selector-module__dateAndTimeSelectorsWrapper",selector_dateAndTimeSelectorsWrapper__hidden:"widget-module__selector_dateAndTimeSelectorsWrapper__hidden",selector_dateAndTimeSelectors:"widget-module__selector_dateAndTimeSelectors selector-module__dateAndTimeSelectors",selector_dateSelector:"widget-module__selector_dateSelector selector-module__dateSelector",selector_timeSelector:"widget-module__selector_timeSelector selector-module__timeSelector",buttonGroup:"widget-module__buttonGroup",button:"widget-module__button",buttonLightOutline:"widget-module__buttonLightOutline","button--disabled":"widget-module__button--disabled",listItem:"widget-module__listItem",itemIcon:"widget-module__itemIcon",itemLocality:"widget-module__itemLocality search-module__itemLocality typography-module__typo-body__secondary",popupContainer:"widget-module__popupContainer search-module__menu",messageBox:"widget-module__messageBox"};var O={MODULE_VERSION:"2.16.1",COMPRESSED_ORG:"GYJwhgtkA",ORG_ID:"fram"};const N=300,y=String.raw,k=O.MODULE_VERSION,I=O.COMPRESSED_ORG;function G(t){if(!(t!=null&&t.startsWith("http")))throw new Error("Missing urlBase in correct schema.");return t.endsWith("/")||(t+="/"),{URL_BASE:t,URL_JS_UMD:`${t}widget/${I}/${k}/planner-web.umd.js`,URL_JS_ESM:`${t}widget/${I}/${k}/planner-web.mjs`,URL_CSS:`${t}widget/${I}/${k}/planner-web.css`}}function R({urlBase:t,language:e="en"}){const i=le(e),n=G(t);return{output:Q(n,i),init:K,urls:n}}function K(){var e,i;J(),B("pw-assistant"),B("pw-departures");let t={from:void 0,to:void 0};document.addEventListener("search-selected",function(n){const r=n;t[r.detail.key]=r.detail.item}),document.addEventListener("reset-search",function(){t={from:void 0,to:void 0},document.querySelectorAll('input[name="from"], input[name="to"]').forEach(n=>{n.value=""})}),document.querySelectorAll("[name$=searchTimeSelector]").forEach(function(n){n.addEventListener("change",function(r){const u=r.currentTarget.value==="now";document.querySelectorAll(".js-search-date-details").forEach(p=>{p.hidden=u})})}),(e=document.querySelector("#pw-form-departures"))==null||e.addEventListener("submit",n=>{n.preventDefault();const r=n.currentTarget;V(r,t.from)}),(i=document.querySelector("#pw-form-assistant"))==null||i.addEventListener("submit",n=>{n.preventDefault();const r=n.currentTarget;U(r,t.from,t.to)})}function B(t){const e=document.querySelector(`#${t}-searchTimeSelector-date`),i=document.querySelector(`#${t}-searchTimeSelector-time`);try{if(e&&(e.valueAsDate=new Date),i){const n=new Date,r=String(n.getHours()).padStart(2,"0"),s=String(n.getMinutes()).padStart(2,"0");i.value=`${r}:${s}`}}catch{}}function P(t,e){const i=t.get(`${e}-searchTimeSelector`);if(i==="now")return{mode:"now"};{const n=t.get("dateinput"),r=t.get("timeinput");if(n&&r){const s=new Date(`${n}T${r}`);return{mode:i=="arriveBy"?"arriveBy":"departBy",dateTime:s.getTime()}}return{mode:"now"}}}function U(t,e,i){const n=t.action,r=P(new FormData(t),"pw-assistant"),s=oe({from:e,to:i},r),u=new URLSearchParams(s);window.location.href=`${n}?${u.toString()}`}function V(t,e){const i=t.action,n=P(new FormData(t),"pw-departures"),r=ne(n,e),s=new URLSearchParams(r);(e==null?void 0:e.layer)==="venue"?window.location.href=`${i}/${e.id}?${s.toString()}`:window.location.href=`${i}?${s.toString()}`}class E extends HTMLElement{constructor(){super()}connectedCallback(){const e=this;e.hidden=!0,e.classList.add(o.messageBox),document.addEventListener("pw-errorMessage",function(i){const n=i;e.textContent=n.detail.message,e.hidden=!1}),document.addEventListener("pw-errorMessage-clear",function(i){e.hidden=!0}),e.addEventListener("click",function(){E.clearMessageBox()})}static clearMessageBox(){document.dispatchEvent(new CustomEvent("pw-errorMessage-clear",{bubbles:!0}))}}function Q({URL_BASE:t},e){function i(a){const c=r(a),_=b("span",[a.name]),d=b("span",[a.locality??""],o.itemLocality),l=b("li",[c,_,d],o.listItem);return l.role="option",l.setAttribute("data-feature-id",a.id),l}function n(a){const c=b("span",[a]);return b("li",[c],o.listItem)}function r(a){const c=X(a.category),_=b("img");_.src=`${t}assets/mono/light/${c.icon}.svg`,_.alt=c.alt,_.role="img";const d=b("div",[_],o.itemIcon);return d.ariaHidden="true",d}class s extends HTMLElement{constructor(){super()}connectedCallback(){const c=this;this.querySelector("button").addEventListener("click",async()=>{var d;E.clearMessageBox();try{const l=await re(t,e),g=(d=c.parentElement)==null?void 0:d.querySelector("input");g&&(g.value=l?`${l.name}, ${l.locality}`:g.value),document.dispatchEvent(new CustomEvent("search-selected",{bubbles:!0,detail:{key:"from",item:l}}))}catch(l){l instanceof Error&&document.dispatchEvent(new CustomEvent("pw-errorMessage",{bubbles:!0,detail:{message:l.message}}))}})}}customElements.define("pw-geobutton",s),customElements.define("pw-messagebox",E);class u extends HTMLElement{constructor(){super(),this.dataList={}}getItem(c){return this.dataList[c]}setItems(c){this.dataList={};for(let _ of c)this.dataList[_.id]=_}connectedCallback(){const c=this,_=z(this.getAttribute("data-debounce-ms"),N),d=this.querySelector("input"),l=this.querySelector("#"+this.getAttribute("for"));let g=new S(d,l,{tabInsertsSuggestions:!0,scrollIntoViewOptions:!1});function $(m){m?g.start():(g.clearSelection(),g.stop()),l.hidden=!m}function W(){c.setItems([]),l.innerHTML="";const m=n(e.noResults);l.appendChild(m),$(!0)}const ue=Y(async m=>{try{if(!m.value){l.innerHTML="";return}const v=await ie(t,m.value);if(v.length===0)return W();c.setItems(v),l.innerHTML="";for(let w of v){const L=i(w);l.appendChild(L)}$(!0)}catch{W()}},_);d.addEventListener("keydown",m=>{m.key==="Escape"&&$(!1)}),d.addEventListener("input",m=>ue(m.target)),d.addEventListener("focus",()=>$(!0)),d.addEventListener("blur",()=>$(!1)),document.addEventListener("click",m=>{j(m.target,this)||$(!1)}),l.addEventListener("combobox-commit",function(m){const v=m.target.getAttribute("data-feature-id"),w=v?c.getItem(v):void 0;let L=d.value;w&&(L=`${w.name}`,w.locality&&(L+=`, ${w.locality}`)),d.value=L,document.dispatchEvent(new CustomEvent("search-selected",{bubbles:!0,detail:{key:d.name,item:w}})),l.hidden=!0,g.clearSelection(),g.stop()})}}customElements.define("pw-autocomplete",u);const p=y`
