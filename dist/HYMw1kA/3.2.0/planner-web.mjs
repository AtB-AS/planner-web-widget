...
var H = { MODULE_VERSION: "3.2.0", COMPRESSED_ORG: "HYMw1kA", ORG_ID: "nfk" };
const Pe = 300, $ = String.raw, A = H.MODULE_VERSION, k = H.COMPRESSED_ORG;
function qe(t) {
...
function Oe(t, e, n) {
  const i = t.action, s = x(new FormData(t), "pw-assistant"), a = Ye({ from: e, to: n }, s), c = new URLSearchParams(a);
  window.location.href = `${i}?${c.toString()}`;
}
function Ne(t, e) {
  const n = t.action, i = x(new FormData(t), "pw-departures"), s = ze(i, e), a = new URLSearchParams(s);
