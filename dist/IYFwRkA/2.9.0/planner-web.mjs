...
var O = { MODULE_VERSION: "2.9.0", COMPRESSED_ORG: "IYFwRkA" };
...
function Me(t, e, i) {
  const n = t.action, a = P(new FormData(t), "pw-assistant"), s = Re({ from: e, to: i }, a), d = new URLSearchParams(s);
  window.location.href = `${n}?${d.toString()}`;
}
function Be(t, e) {
  const i = t.action, n = P(new FormData(t), "pw-departures"), a = xe(n, e), s = new URLSearchParams(a);
